...
- [[copilot/agents/plan.agent/rules/code.rules/_|Universal Rules]]
- [[copilot/agents/plan.agent/rules/js.rules/_|JavaScript Rules]]
- [[copilot/agents/plan.agent/rules/ts.rules/_|TypeScript Rules]]
- [[copilot/agents/plan.agent/rules/py.rules/_|Python Rules]]
## Source code
