...
ONLY annotate parameters with function typel literals, NEVER variables
AVOID annotating with conditional type expressions
NEVER annotate with union or intersection type expressions
NEVER use the same function type literal more than once
...
WHEN a discriminant describes type, use `type`
## Code
